package com.lisheng.july.aspect;

import com.alibaba.fastjson.JSONObject;
import com.lisheng.july.base.MySysUser;
import com.lisheng.july.entity.Log;
import com.lisheng.july.exception.GlobalExceptionHandler;
...
public class WebLogAspect {
    ...
    @Pointcut("@annotation(com.lisheng.july.annotation.SysLog)")
    public void webLog(){}
    ...
    public void doBefore(JoinPoint joinPoint) {
        ...
        com.lisheng.july.annotation.SysLog mylog = method.getAnnotation(com.lisheng.july.annotation.SysLog.class);
        if(mylog != null){
            //注解上的描述
